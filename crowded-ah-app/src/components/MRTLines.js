...
const MRTLines = () => {
  ...
  const mrtLines = {
    ...
    'East-West Line': {code: 'EWL', station: [{ code: 'EW1', name: 'Changi Airport' },{ code: 'EW2', name: 'Expo' },{ code: 'EW3', name: 'Pasir Ris' },{ code: 'EW4', name: 'Tampines' },{ code: 'EW5', name: 'Simei' },{ code: 'EW6', name: 'Tanah Merah' },{ code: 'EW7', name: 'Bedok' },{ code: 'EW8', name: 'Kembangan' },{ code: 'EW9', name: 'Eunos' },{ code: 'EW10', name: 'Paya Lebar' },{ code: 'EW11', name: 'Aljunied' }, { code: 'EW12', name: 'Kallang' },{ code: 'EW13', name: 'Lavender' },{ code: 'EW14', name: 'Bugis' },{ code: 'EW15', name: 'City Hall' },{ code: 'EW16', name: 'Raffles Place' },{ code: 'EW17', name: 'Tanjong Pagar' },{ code: 'EW18', name: 'Outram Park' },{ code: 'EW19', name: 'Tiong Bahru' },{ code: 'EW20', name: 'Redhill' },{ code: 'EW21', name: 'Queenstown' },{ code: 'EW22', name: 'Commonwealth' },{ code: 'EW23', name: 'Buona Vista' },{ code: 'EW24', name: 'Dover' },{ code: 'EW25', name: 'Clementi' },{ code: 'EW26', name: 'Jurong East' },{ code: 'EW27', name: 'Chinese Garden' },{ code: 'EW28', name: 'Lakeside' },{ code: 'EW29', name: 'Boon Lay' },{ code: 'EW30', name: 'Pioneer' },{ code: 'EW31', name: 'Joo Koon' },{ code: 'EW32', name: 'Gul Circle' },{ code: 'EW33', name: 'Tuas Crescent' },{ code: 'EW34', name: 'Tuas West Road' },{ code: 'EW35', name: 'Tuas Link' }]},
    'North East Line': {code: 'NEL', station: [{ code: 'NE1', name: 'HarbourFront' },{ code: 'NE2', name: 'Outram Park' },{ code: 'NE3', name: 'Chinatown' },{ code: 'NE4', name: 'Clarke Quay' },{ code: 'NE5', name: 'Dhoby Ghaut' },{ code: 'NE6', name: 'Little India' },{ code: 'NE7', name: 'Farrer Park' },{ code: 'NE8', name: 'Boon Keng' },{ code: 'NE9', name: 'Potong Pasir' },{ code: 'NE10', name: 'Woodleigh' },{ code: 'NE11', name: 'Serangoon' },{ code: 'NE12', name: 'Kovan' },{ code: 'NE13', name: 'Hougang' },{ code: 'NE14', name: 'Buangkok' },{ code: 'NE15', name: 'Sengkang' },{ code: 'NE16', name: 'Punggol' }]},
    'North-South Line': {code: 'NSL', station: [{ code: 'NS1', name: 'Jurong East' },{ code: 'NS2', name: 'Jurong West' },{ code: 'NS3', name: 'Choa Chu Kang' },{ code: 'NS4', name: 'Kranji' },{ code: 'NS5', name: 'Yew Tee' },{ code: 'NS6', name: 'Bukit Gombak' },{ code: 'NS7', name: 'Bishan' },{ code: 'NS8', name: 'Braddell' },{ code: 'NS9', name: 'Toa Payoh' },{ code: 'NS10', name: 'Novena' },{ code: 'NS11', name: 'Newton' },{ code: 'NS12', name: 'Dhoby Ghaut' },{ code: 'NS13', name: 'City Hall' },{ code: 'NS14', name: 'Raffles Place' },{ code: 'NS15', name: 'Outram Park' },{ code: 'NS16', name: 'Tiong Bahru' },{ code: 'NS17', name: 'Redhill' },{ code: 'NS18', name: 'Queenstown' },{ code: 'NS19', name: 'Commonwealth' },{ code: 'NS20', name: 'Buona Vista' },{ code: 'NS21', name: 'Dover' },{ code: 'NS22', name: 'Clementi' },{ code: 'NS23', name: 'Jurong East' },{ code: 'NS24', name: 'Chinese Garden' },{ code: 'NS25', name: 'Lakeside' },{ code: 'NS26', name: 'Boon Lay' },{ code: 'NS27', name: 'Pioneer' },{ code: 'NS28', name: 'Joo Koon' },{ code: 'NS29', name: 'Gul Circle' },{ code: 'NS30', name: 'Tuas Crescent' },{ code: 'NS31', name: 'Tuas West Road' },{ code: 'NS32', name: 'Tuas Link' }]},
    'Thomson-East Coast Line': {code: 'TEL', station: [{ code: 'TE1', name: 'Woodlands North' },{ code: 'TE2', name: 'Woodlands' },{ code: 'TE3', name: 'Admiralty' },{ code: 'TE4', name: 'Sembawang' },{ code: 'TE5', name: 'Canberra' },{ code: 'TE6', name: 'Sembawang' },{ code: 'TE7', name: 'Mandai' },{ code: 'TE8', name: 'Bishan' },{ code: 'TE9', name: 'Marymount' },{ code: 'TE10', name: 'Caldecott' },{ code: 'TE11', name: 'Botanic Gardens' },{ code: 'TE12', name: 'Stevens' },{ code: 'TE13', name: 'Newton' },{ code: 'TE14', name: 'Little India' },{ code: 'TE15', name: 'Rochor' },{ code: 'TE16', name: 'Bugis' },{ code: 'TE17', name: 'Promenade' },{ code: 'TE18', name: 'Bayfront' },{ code: 'TE19', name: 'Downtown' }]}
  };
