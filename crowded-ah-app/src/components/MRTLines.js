              ...
              <li key={index} className={`mrt-station-item ${lineClasses[line].itemClass}`}>
                ...
                <div className="crowd-density">
                  ...
                  <div className="crowd-density-box">
                      <div className={`crowd-level ${getCrowdLevel(mrtLines[line].code, station.code)}`}>
                          <div className={`crowd-level-dot ${getCrowdLevel(mrtLines[line].code, station.code)}`}></div>
                          {CrowdLabel(getCrowdLevel(mrtLines[line].code, station.code))}
                      </div>
                  </div>
                  <span>Forecast:</span>
                  <div className="crowd-density-box">
                      <div className={`crowd-level ${getCrowdLevel(mrtLines[line].code, station.code, true)}`}>
                          <div className={`crowd-level-dot ${getCrowdLevel(mrtLines[line].code, station.code, true)}`}></div>
                          {CrowdLabel(getCrowdLevel(mrtLines[line].code, station.code, true))}
                      </div>
                  </div>
              </div>
              </li>
