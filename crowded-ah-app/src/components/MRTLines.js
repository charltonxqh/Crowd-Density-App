...
=======
  ...
  const handleToggle = (line) => {
    ...
    setOpenLine(prevLine => (prevLine === line ? null : line));
  ...
  const handleStationClick = (station) => {
    ...
    navigate(`/stations/${station.code}`);
  };
  ...
  const getCrowdLevel = (line, stationCode, isForecast = false) => {
    ...
    if (trainData[type] && trainData[type][line] && trainData[type][line][stationCode]) {
                    ...
                    <li key={index} className="mrt-station-item">
                      ...
                      <div className="crowd-density">
                        ...
                        <div className="crowd-density-box">
                          <div className={`crowd-level ${getCrowdLevel(line, station.code, false)}`}>
                            <div className={`crowd-level-dot ${getCrowdLevel(line, station.code, false)}`}></div>
                            {CrowdLabel(getCrowdLevel(line, station.code, false))}
                          </div>
                        </div>
                        <span>Forecast:</span>
                        <div className="crowd-density-box">
                          <div className={`crowd-level ${getCrowdLevel(line, station.code, true)}`}>
                            <div className={`crowd-level-dot ${getCrowdLevel(line, station.code, true)}`}></div>
