...
const MRTLines = () => {
  ...
  const lineClasses = {
    "Circle Line": {
      buttonClass: "circle-line",
      dropdownClass: "circle-line-dropdown",
      itemClass: "circle-line-items",
    },
    "Downtown Line": {
      buttonClass: "downtown-line",
      dropdownClass: "downtown-line-dropdown",
      itemClass: "downtown-line-items",
    },
    "East-West Line": {
      buttonClass: "east-west-line",
      dropdownClass: "east-west-line-dropdown",
      itemClass: "east-west-line-items",
    },
    "North East Line": {
      buttonClass: "north-east-line",
      dropdownClass: "north-east-line-dropdown",
      itemClass: "north-east-line-items",
    },
    "North-South Line": {
      buttonClass: "north-south-line",
      dropdownClass: "north-south-line-dropdown",
      itemClass: "north-south-line-items",
    },
    "Thomson-East Coast Line": {
      buttonClass: "thomson-east-coast-line",
      dropdownClass: "thomson-east-coast-line-dropdown",
      itemClass: "thomson-east-coast-line-items",
    },
  };
    ...
    <div>
      {Object.keys(mrtLines).map((line) => (
        <div key={line}>
          ...
          >
            <span
              className={`station-code-box-${line
                .toLowerCase()
                .replace(/\s+/g, "-")}`}
            >
          ...
          {openLine === line && (
            <ul
              className={`mrt-station-list ${lineClasses[line].dropdownClass}`}
            >
              {mrtLines[line].station.map((station, index) => (
                <li
                  key={index}
                  className={`mrt-station-item ${lineClasses[line].itemClass}`}
                >
                  <button
                    key={station.code}
                    className={`station-code-box-${line
                  ...
                  <span
                    className={`crowd-density-indicator ${getCrowdLevel(
                      mrtLines[line].code,
                      station.code
                    )}`}
                  ...
                  >
                    {CrowdLabel(
                      getCrowdLevel(mrtLines[line].code, station.code)
                    )}
                  </span>
                </li>
              ))}
      ...
      {selectedStation && (
        <StationPopup station={selectedStation} onClose={handleClosePopup} />
      )}
    </div>
  );
};
